  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
        {post.featured_image && (
          <div className="relative aspect-[4/3] w-full md:w-64 rounded bg-stone-200 shrink-0 overflow-hidden shadow-sm transition-all duration-500 border border-stone-300">
            <Image
